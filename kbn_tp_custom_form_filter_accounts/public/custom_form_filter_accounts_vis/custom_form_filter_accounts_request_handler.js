...
/* return true if at least 1 filter was found matching both controlledById and filterCounter */
...
/* return all filters matching controlledById */
...
/* return true if some filters were found and deleted */
...
export const customFormFilterAccountsRequestHandler = async (vis) => {

  const controlledById = 'accountsFilter' + ':';
  ...
  if(vis.visParams.minimumBalance != null)
    minimumBalanceFilter = {
      ...
      "range": {
        "balance": {
          "gte": vis.visParams.minimumBalance,
